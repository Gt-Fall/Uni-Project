...
export default function GetIncompleteTable({
  incompleteOr,
  setButtonID,
  setShowFormOrder,
  setShowFormManual,
  ...
  const orderedArray = [...incompleteOr].sort((a, b) =>
    a.Order_Number < b.Order_Number ? -1 : 1
  );

  function handleClick(editID) {
    //console.log("edit clicked Open", editID);
    setButtonID(editID);
